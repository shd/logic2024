...
\begin{minipage}{2cm}\center\footnotesize\includegraphics[scale=0.25]{pics/lection-14-ox}\\голова быка\end{minipage}&
...
\begin{minipage}{2cm}\center\footnotesize\includegraphics[scale=0.25]{pics/lection-14-house}\\дом\end{minipage} & &  $\beth$ бейт &  b, Б, $\beta$\\
\begin{minipage}{2cm}\center\footnotesize\includegraphics[scale=0.25]{pics/lection-14-throwstick}\\метательная палка\end{minipage} & гамл &   $\gimel$ гимель &  Г\\
\begin{minipage}{2cm}\center\footnotesize\includegraphics[scale=0.25]{pics/lection-14-door}\\дверь/рыба\end{minipage} & далт & далет &  Д, D, $\Delta$
\end{tabular}
\end{comment}
