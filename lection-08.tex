...
\item Общеотрицательное предложение --- когда $a,d$ или $b,c$ имеют общий делитель:\\
...
\begin{itemize}
\item Очевидно, силлогизм <<Barbara>> верен: $$\infer{a \divisible e, b \divisible f}{+a-b\text{ есть }+c-d\quad\quad+c-d\text{ есть }+e-f}$$
