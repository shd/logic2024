...
\item Заметим, что на $\mathbb{R}$ ровно два множества одновременно открыты и замкнуты --- $\varnothing$ и всё пространство. Постройте другую
...
хотя такой круг существует на $\{ z\ |\ z \in \mathbb{R}^2, |z| \le 0.5\}$.
