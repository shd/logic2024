...
\item Покажите, что следующие утверждения верны для импликативных решёток:
\begin{enumerate}
...
Возможно, вам тут также потребуется условие непоустоты --- в таком случае приведите контрпример при его отсутствии.
...
\item Докажите, что теорема Гливенко не верна в интуиционистском исчислении предикатов. 
...
\item Докажите, что для любого выражения $\varphi$ найдётся эквивалентное ему выражение без поверхностных кваторов $\psi$. В доказательстве можно ссылаться на предыдущие пункты
