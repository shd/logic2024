...
В этих задачах вводится ранжирование задач по сложности. Простые задачи будут оцениваться в 2 балла (от $1.5$ до $2.5$),
сложные задачи -- как раньше, в 3.5 балла. Сложные задачи отмечены звёздочкой.
